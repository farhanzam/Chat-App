...
import { query, limit, addDoc, onSnapshot, collection } from "firebase/firestore";
import { User } from 'firebase/auth';
import { useRouter } from 'next/navigation'
import MyUser from '@/components/myUser';


// this page defines the Matching Room, where users can find and click on other users currently waiting to begin a conversation
...
export default function MatchingRoom({ signedInUser }: MatchingRoomProps) {
  ...
  // when the user clicks on another user, take the user to the chatroom
  return(
    <div>
